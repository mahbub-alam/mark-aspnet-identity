...
{
    /// <summary>
    /// Represents factory for building component related to database repository.
    /// </summary>
    public abstract class DbRepositoryComponentFactory
    {
        /// <summary>
        ...
        public abstract DbQueryBuilder<TEntity> CreateQueryBuilder<TEntity, TQueryBuilder>(
        ...
        public abstract DbEntityBuilder<TEntity> CreateEntityBuilder<TEntity>(
            IDbStorageContext storageContext)
