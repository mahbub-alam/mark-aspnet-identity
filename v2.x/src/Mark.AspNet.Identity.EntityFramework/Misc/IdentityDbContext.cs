...
namespace Mark.AspNet.Identity.EntityFramework
{
    ...
    /// <typeparam name="TUserRole">User role entity type.</typeparam>
    /// <typeparam name="TUserClaim">User claim entity type.</typeparam>
    public class IdentityDbContext<TUser, TRole, TUserLogin, TUserRole, TUserClaim> : DbContext
        where TUser : IdentityUser<string, TUserLogin, TUserRole, TUserClaim>
        where TRole : IdentityRole<string, TUserRole>
        where TUserLogin : IdentityUserLogin
        where TUserRole : IdentityUserRole
        where TUserClaim : IdentityUserClaim
    {
        private IdentityUserMap<TUser, TUserLogin, TUserRole, TUserClaim> _userMap;
        private IdentityRoleMap<TRole, TUserRole> _roleMap;
        private IdentityUserLoginMap<TUserLogin> _userLoginMap;
        private IdentityUserRoleMap<TUserRole> _userRoleMap;
        private IdentityUserClaimMap<TUserClaim> _userClaimMap;
        ...
        /// </summary>
        /// <param name="map">Mapping. If null, the default mapping will be used.</param>
        protected void SetIdentiyUserMap(IdentityUserMap<TUser, TUserLogin, TUserRole, TUserClaim> map)
        {
            if (map != null)
            {
                _userMap = map;
            ...
            {
                _userMap = new IdentityUserMap<TUser, TUserLogin, TUserRole, TUserClaim>(
                    new UserConfiguration<TUser, string, TUserLogin, TUserRole, TUserClaim>());
            }
        }
        ...
        /// </summary>
        /// <param name="map">Mapping. If null, the default mapping will be used.</param>
        protected void SetIdentiyRoleMap(IdentityRoleMap<TRole, TUserRole> map)
        {
            if (map != null)
            {
                _roleMap = map;
            ...
            {
                _roleMap = new IdentityRoleMap<TRole, TUserRole>(
                    new RoleConfiguration<TRole, string, TUserRole>());
            }
        }
        ...
        /// </summary>
        /// <param name="map">Mapping. If null, the default mapping will be used.</param>
        protected void SetIdentiyUserLoginMap(IdentityUserLoginMap<TUserLogin> map)
        {
            if (map != null)
            {
                _userLoginMap = map;
            ...
            {
                _userLoginMap = new IdentityUserLoginMap<TUserLogin>(
                    new UserLoginConfiguration<TUserLogin, string>());
            }
        }
        ...
        /// </summary>
        /// <param name="map">Mapping. If null, the default mapping will be used.</param>
        protected void SetIdentiyUserRoleMap(IdentityUserRoleMap<TUserRole> map)
        {
            if (map != null)
            {
                _userRoleMap = map;
            ...
            {
                _userRoleMap = new IdentityUserRoleMap<TUserRole>(
                    new UserRoleConfiguration<TUserRole, string>());
            }
        }
        ...
        /// </summary>
        /// <param name="map">Mapping. If null, the default mapping will be used.</param>
        protected void SetIdentiyUserClaimMap(IdentityUserClaimMap<TUserClaim> map)
        {
            if (map != null)
            {
                _userClaimMap = map;
            ...
            {
                _userClaimMap = new IdentityUserClaimMap<TUserClaim>(
                    new UserClaimConfiguration<TUserClaim, string>());
            }
        }
    }
